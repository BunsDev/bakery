...
const FarmCards: React.FC = () => {
  ...
  const gdaoIndex = farms.findIndex(
    ({ tokenSymbol }) => tokenSymbol === 'GDAO',
  )

  console.log(stakedValue);

  const gdaoPrice =
    gdaoIndex >= 0 && stakedValue[gdaoIndex]
      ? stakedValue[gdaoIndex].tokenPriceInWeth
      : new BigNumber(0)

  const BLOCKS_PER_YEAR = new BigNumber(2336000)
  const GDAO_PER_BLOCK = new BigNumber(100)
...
const FarmCard: React.FC<FarmCardProps> = ({ farm }) => {
  ...
  }, [gdao, lpTokenAddress, account, setHarvestable])
          ...
          <StyledContent>
            ...
            <StyledInsight>
              ...
              <span>
                {farm.apy
                  ? `${farm.apy
                      .times(new BigNumber(100)) // from 100
